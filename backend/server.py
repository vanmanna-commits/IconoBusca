...
async def search_images(
    ...
    valid_sources = ["google", "unsplash", "pexels", "pixabay", "shutterstock", "getty_images", "istock", "pulsar_imagens", "fotoarena", "usp_imagens", "tyba", "natureza_brasileira", "fabio_colombini", "freepik"]
